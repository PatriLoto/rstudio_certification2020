...
style_duo_accent(
  ...
  code_font_google   = google_font("Fira Mono", "400")
)
```
...
---
## `r emo::ji("bulb")`Antes de continuar 

### Recordemos algunos operadores ya aprendidos que nos ayudarán en combinación con `filter()`
