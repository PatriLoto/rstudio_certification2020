...
##`r emo::ji("link")` .hand[<span style="font-size:80pt">https://rstudio.cloud/project/17826088</span>]
...
knitr::include_graphics("img/mapa_conceptual_4.png")
```
...
### Recordemos algunos operadores ya aprendidos que nos ayudarán con en combinación con `filter()`
